...
- [RyuuGames](https://www.ryuugames.com/tag/japanese/) - Has a ton of visual novels.  Virus warning: Ensure you have the latest version of uBlock Origin, use FastForward (Universal Bypass) and take extra care to ensure the file you're downloading is the actual game. Ryuu uses deceptive ads that redirect you to bogus file downloads containing malware. Submit EVERY file you get to VirusTotal.
- [RyuuBlogger](https://ryuubloggerv2.blogspot.com/) - Also has a ton of visual novels. Virus warning: Ensure you have the latest version of uBlock Origin, have FastForward (Universal Bypass) and take extra care to ensure the file you're downloading is the actual game. Ryuu uses deceptive ads that redirect you to bogus file downloads containing malware. Submit EVERY file you get to VirusTotal.
