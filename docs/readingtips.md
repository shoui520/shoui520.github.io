...
Or maybe just starting out = "I have been learning Japanese for a while with [x] way and I want to start reading for real! What should I do?""  

Then read the rest of the article.  

### Visual novels = better for beginners?  
...
They are more approachable than novels difficulty-wise and therefore they are perfect for easing yourself into reading.  
...
Everything you need to know is in [VN guide](https://nyaa.si/view/1350523)  

### Read the book of something you've seen  
...
Learning how to visual scenes in your head is a different skill than just "Be native".  

You can apply the same exact strategy to Japanese. 

And it's the strategy that I recommend everyone takes when they get into reading.  

**Read the light novel series of an anime you liked.**  
...
Anyway this is obviously a God tier reading strategy because by watching the anime you have given context to the text on the page which translates into i+1 Krashen approved effective language learning gains and also the light novel will have multiple volumes which is great for learners because getting used to 1 author's writing style is easier than reading a different author every time.  
...
The Pomodoro method is when you focus on a task (usually 25 minutes) and after your focus minutes are up, the timer rings and you have a short break (usually 5 minutes.)  

So you will be reading in 20 minute sessions.  

It doesn't really sound like much, but it is actually a very useful method.  

I usually drink water or get up / walk around during break times, it helps to get refreshed before reading again.  

Here's the Pomodoro timer that I use.  **[Pomofocus.io](https://pomofocus.io/)**  

The default settings are 25 minutes focus, 5 minute short break and 15 minute long break.  
...
You need to make reading into a habit; do reading in amounts that are manageable to you every day.  
...
I came up with the idea when I noticed when I read in English, the nouns stand out.  

Nouns are names, people, objects, places, etc.  

I felt like there is some type of word hierarchy.  

Any nouns/numbers → "action" verbs → adjectives → "abstract" verbs.  

And of course, within nouns there is also a noun hierachy, with names, pronouns and physical objects being at the top.  

I noticed when I read Japanese, it feels a lot more hazy because my brain just doesn't make the nouns stand out more than adjectives or verbs.  
...
If you haven't studied a lot of grammar and don't know all JLPT N5, N4, N3, N2 and N1 grammar points, then I highly recommend you study them. But I don't mean this to say "study jlpt grammar before reading", "I mean, study jlpt grammar to improve your reading experience, which you should be doing, probably right about now"  
...
- ALL the grammar ones.  
- 実用日本語表現辞典
- Your favourite monolingual dictionary. (if you dont have a favourite then use either one of my favourites: 新明解国語辞典 第七版、明鏡国語辞典 第二版(doesnt work with anki btw) or 旺文社国語辞典 第十一版)  
...
I'm just gonna go out and say this right now.  

You will only get faster at reading by reading more.  

You are only able to read at that speed you are at right now because that is the speed someone, who has read the amount you have and the material you have, would be reading at in a perfectly normal situation.  


### READING SPEED TIPS AND TRICKS    

I have some breaking news for you... the best reading speed technique is to read more.  
...
**Q:** Should i read a ton of manga if i want to get fast at reading wikipedia articles?  
...
But what if you've already done that but you still didn't understand?    

The simple answer is to read more.  

Because comprehension is a gradual process.  

The factors that go into "comprehending/understanding" are much more broad than "knowing the word" and "have studied the grammar".  

When you read more you will see words used in many, many different contexts. 

And it is through your experience seeing these words in different contexts, you learn to comprehend more sentences.  

As much as I don't like to admit it, there is another way of training comprehension too. And that is by analyzing the sentence by referring to grammar points, dictionary definitions, example sentences, HiNative and Yahoo!知恵袋 answers etc. If you have the drive to do all of that then I'd say you can't go wrong with that but at the same time there is no way you can't be not improving by just reading more so I would say this decision is all on you. Perhaps learning to balance analyzing and just reading more is a useful skill to have.  
...
And as a high believer in reading more and ex-high believer in analyzing sentences I'd say there is only so much comprehension you can get out of analyzing unfamiliar sentences; the learner that has read a ton will understand a lot more than the learner that just analyzes everything.  
...
### Comprehension Nayamigoto Type 2.5

Type 2.5: "I can read all the words, I know all their meanings, but I can't visualize the scene! I don't understand what is actually going on! I have to analyze and even then I have no clue what is happening, what should I do?"  
...
A: Well everything boils down to "read more". The theory behind why I answered with "read more" is because: Your comprehension lacks because the kinds of sentences you struggle with are sentences you are unfamiliar with. In language acquisition, force feeding yourself too-unfamiliar sentences is not as effective as understanding i+1 sentences. (only 1 thing in the sentence you aren't so comfortable with, these "things" may not even be identifiable). When you read more **you will come across a crap ton of sentences**, and within these sentences, there will be plenty of i+1 sentences, and this is the peak of your language acquistion gains. Therefore, after reading a lot you will become better at Japanese, and you'll struggle less with those hard to visualize, hard sentences.  

### Comprehension Nayamigoto Type 3

Type 3: "I feel like I'm only half-understanding"  

Just read more, read more sentences and you'll start understanding other sentences!!  
...
This is just a fancy way of saying "this means this, there is no need to read word for word, and i will keep a note of it".  

**Q:** No subvocalization = no comprehension?  

In my experience, when the words/sentences you are choosing to not subvocalize are not that familiar to you (i.e. you cannot understand it just by glancing at it. An example that experienced readers should understand without reading word for word is なければならない) then you will end up not understanding what it is actually saying.  

Subvocalizing is a useful reading technique and most people do it and if you read a lot your subvocalization will just get faster.  

So don't stop subvocalizing because you think it's slowing you down. It is not. The only things slowing you down is: You worrying too much about speed and character count, the fact that you haven't read enough and it is pretty much common sense that you wouldn't be lightning fast at reading a text in a language you basically don't have much experience with when compared to a native.  

Reading more is the crux of increasing reading speed, so don't forget!    


### I can't read! I am not a reader! I am too dumb/adhd/young/bad memory to read!
C O P E.  
...
Kinda a dumb question because you never stop reading because you can always get better.   
...
If you mine the entirety of around 30-40 novels and use monolingual dictionaries you will have a very decent vocabulary size and you will understand a lot more from listening and whatever.  
